...
/**
 * Array of msg_entry needed for @p mavlink_parse_char() (trought @p 7())
 */
...
def copy_fixed_headers(directory, xml):
    ...
    srcpath = os.path.join(basepath, 'UE4/include_v%s' % xml.wire_protocol_version)
...
def generate(basename, xml_list):
    '''generate serialization MAVLink C++ for UE4 implemenation'''
